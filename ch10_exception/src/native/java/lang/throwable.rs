...
use crate::rtda::heap::consts::THROWABLE_CLASS;
use crate::rtda::object::{Object, ObjectExtra};
...
pub(crate) fn init(data: &mut HashMap<String, NativeMethod>) {
    ...
    debug!("NativeRegistry: throwable native method registered!")
}
