...
use crate::rtda::heap::string_pool::rust_string;
...
fn handle_uncaught_exception(ex: RcRefCell<Object>) {
    ...
    let j_msg = ex_mut.get_ref_var("detailMessage".into(), "Ljava/lang/String;".into());
    ...
    let stes = ex_mut
        ...
        .unwrap()
        .as_any()
        .downcast_ref::<Vec<native::throwable::StackTraceElement>>()
        .unwrap();
